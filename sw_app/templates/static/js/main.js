$(document).ready(function()
		{
			...
			$('.section1').css('height', newSecOneHeight+70);
			$('.section1').css('padding-top', ((newSecOneHeight/2)-(secOneContentHeight/2)-100)+"px")



			$(window).scroll(function()
			{
				var winScroller = Math.round(($(this).scrollTop()/2)-550);
			...
			$('#b1').css({'padding-top':servicesPadding, 'padding-bottom':servicesPadding})
			$('#b2').css({'padding-top':servicesPadding, 'padding-bottom':servicesPadding})
			$('#b3').css({'padding-top':servicesPadding, 'padding-bottom':servicesPadding})
			$('#b4').css({'padding-top':servicesPadding, 'padding-bottom':servicesPadding})
